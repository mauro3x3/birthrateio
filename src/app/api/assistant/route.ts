...
- /maps and /maps/<iso3> : Census-style regional choropleths (TFR, population, population change). Countries include India, Pakistan, Nigeria (NDHS 2023–24 states), Brazil (IBGE 2023), Colombia (DANE TGF 2023–24 departments, national 1.1 in 2024; Chart 7 national TGF 1.0 in 2025 on /fertility/race and the South America map), Argentina (RENAPER/DNP provincial TGF 2024 + provisional 2025, national 1.04), Indonesia (BPS SUPAS 2025, 38 provinces, national TFR 2.13), Iran (BirthGauge 2025 provinces, national TFR 1.47), Kenya, Japan, Germany, Turkey, Ghana, Bangladesh, Tanzania, Angola, South Africa, Jordan, Nepal, the Philippines, plus EU / MENA / Africa / Caribbean / South America / Southeast Asia / Central America / Central Asia / North America / Oceania / Pan Asia (Asia + Middle East, decade frames 1960–2020) country-level maps. Continental country maps use BirthGauge’s latest compiled TFR where it exists (Caribbean: Cuba 1.12 and Puerto Rico 0.85 in 2025, Dominican Republic 1.95 in 2024; Egypt 2.52 in 2026), otherwise World Bank WDI. Guyana 1.75 on the South America map is an unofficial 2025 estimate from GRO registered live births (13,132), not a Bureau of Statistics TFR. Venezuela 2.01 is UCAB ENCOVI 2023 (household survey), not INE vital statistics. Nicaragua 2.2 on the Central America map is INIDE’s 2020–2025 TGF (BCN Nicaragua en Cifras 2025), not BirthGauge 2020. El Salvador 1.4 is the 2024 census TGF (BCR/ONEC), not World Bank WDI. The Africa map overlays recent DHS/MIS national TFR (2020–25) plus Congo-Brazzaville EDSC-III 2025 (3.5) and Stats SA 2026 (2.12); remaining countries stay on WDI. Haiti has no BirthGauge series and stays on World Bank (2.62).
...
- /country/<slug>/brief : AI demographic briefing builder — user picks sections and charts; every country; Israel includes CBS religion TFR, CBS religiosity (Haredi 6.8 in 2022–24), IDI employment/fiscal context, settlers, coalition stakes
`.trim();
...
- Explorers: /topics /why /fertility /population /population/shares /migration /mortality /crime /workers-retirees /demographics /demographics/us /gdp /maps /cities /calendar /clock /contribute.
