...
import {
  TFR_DECOMPOSITION_ALL,
} from "@/lib/sources/tfr-decomposition-data";

export const metadata: Metadata = {
  title: "Many Mothers or Large Families? Decomposing the Fertility Rate",
  description:
    "The total fertility rate is the product of two independent forces: the share of women who become mothers, and the average number of children those mothers have. Compare countries — and US race and Hispanic-origin groups — on both.",
  ...
  return (
    <div>
      ...
      <div className="container space-y-10 py-8">
        <TfrDecompositionSection rows={TFR_DECOMPOSITION_ALL} />
      </div>
    </div>
  );
}
