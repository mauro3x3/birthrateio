...
export const metadata: Metadata = {
  ...
  description:
    "Census-style choropleth maps of total fertility rate, population, and population change for states, provinces and regions — plus Europe (NUTS 2 provinces, EU countries, or population/birth shares), MENA, Africa, Caribbean, South America, Central America and Oceania. New layers include Iraq governorates (2025), Mexico states (2024), and a historic empires hub. Saudi Arabia includes a census toggle for Saudi women versus all residents. India, Pakistan, Nigeria, Brazil, Colombia, Indonesia, Iran, Japan, Germany, Turkey and dozens of other official sources.",
