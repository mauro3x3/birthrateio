...
const FEATURED: FeaturedPlace[] = [
  ...
  { slug: "pakistan", name: "Pakistan", aliases: ["pakistan"], region: "Pakistan", mapIso3: "pak" },
  ...
  { slug: "nigeria", name: "Nigeria", aliases: ["nigeria"], region: "Africa", mapIso3: "nga", tfr: "high" },
  ...
  { slug: "brazil", name: "Brazil", aliases: ["brazil"], region: "Brazil", mapIso3: "bra" },
  { slug: "colombia", name: "Colombia", aliases: ["colombia"], region: "Colombia", mapIso3: "col" },
  { slug: "argentina", name: "Argentina", aliases: ["argentina"], region: "Argentina", mapIso3: "arg", tfr: "low" },
  { slug: "mexico", name: "Mexico", aliases: ["mexico"], region: "Mexico", mapIso3: "mex", tfr: "low" },
  { slug: "iraq", name: "Iraq", aliases: ["iraq"], region: "Middle East", mapIso3: "irq" },
  ...
  { slug: "indonesia", name: "Indonesia", aliases: ["indonesia"], region: "Asia", mapIso3: "idn" },
  { slug: "kenya", name: "Kenya", aliases: ["kenya"], region: "Africa", mapIso3: "ken", tfr: "high" },
  { slug: "turkey", name: "Turkey", aliases: ["turkey", "turkiye"], region: "Turkey", mapIso3: "tur" },
  { slug: "philippines", name: "Philippines", aliases: ["philippines"], region: "Asia", mapIso3: "phl" },
  { slug: "ghana", name: "Ghana", aliases: ["ghana"], region: "Africa", mapIso3: "gha", tfr: "high" },
  { slug: "bangladesh", name: "Bangladesh", aliases: ["bangladesh"], region: "Asia", mapIso3: "bgd" },
  { slug: "nepal", name: "Nepal", aliases: ["nepal"], region: "Asia", mapIso3: "npl" },
];
...
const STATISTICS: StatisticDef[] = [
  ...
  {
    id: "census-maps",
    title: "Census maps — ethnicity, ancestry, and country of birth",
    href: "/demographics",
    region: "Worldwide",
    topicIds: ["maps", "census", "migration"],
    keywords: [
      "census",
      "ethnicity",
      "ethnic group",
  ...
  {
    id: "census-uk",
    title: "UK census ethnicity map",
    href: "/demographics/uk",
    region: "UK",
    topicIds: ["maps", "census", "migration"],
    keywords: ["uk census", "england ethnicity", "msoa"],
  },
  {
    id: "census-us",
    title: "US race and Hispanic origin by state",
    href: "/demographics/us",
    region: "USA",
    topicIds: ["maps", "census"],
    keywords: ["us census", "hispanic origin", "race by state"],
  },
  {
    id: "census-iran",
    title: "Iran ethnic groups map",
    href: "/demographics/iran",
    region: "Iran",
    topicIds: ["maps", "census"],
    keywords: [
      "iran ethnicity",
  ...
  {
    id: "census-brazil",
    title: "Brazil colour / race by state",
    href: "/demographics/brazil",
    region: "Brazil",
    topicIds: ["maps", "census"],
    keywords: ["brazil race", "pardo", "ibge cor ou raca", "brazil census"],
  },
  {
    id: "census-canada",
    title: "Canada visible minority by province",
    href: "/demographics/canada",
    region: "Canada",
    topicIds: ["maps", "census"],
    keywords: ["canada visible minority", "statcan ethnicity", "canada census"],
  },
  {
    id: "census-south-africa",
    title: "South Africa population group by province",
    href: "/demographics/south-africa",
    region: "South Africa",
    topicIds: ["maps", "census"],
    keywords: [
      "south africa race",
  ...
  {
    id: "tfr-religion-india",
    title: "Fertility by religion in India",
    href: "/country/india",
    region: "India",
    topicIds: ["fertility"],
    keywords: [
  ...
  {
    id: "tfr-maps-pak",
    title: "Pakistan fertility by province",
    href: "/maps/pak",
    region: "Pakistan",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-nga",
    title: "Nigeria fertility by state",
    href: "/maps/nga",
    region: "Africa",
    topicIds: ["fertility", "maps"],
    keywords: ["nigeria fertility", "ndhs", "lagos tfr", "kano", "nigeria map"],
  },
  {
    id: "tfr-maps-eu",
    title: "Europe fertility by province",
    href: "/maps/eu",
    region: "Europe",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-bra",
    title: "Brazil fertility by state",
    href: "/maps/bra",
    region: "Brazil",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-idn",
    title: "Indonesia fertility by province",
    href: "/maps/idn",
    region: "Asia",
    topicIds: ["fertility", "maps"],
    keywords: ["indonesia fertility", "supas 2025", "bps tfr", "jakarta tfr", "idhs"],
  },
  {
    id: "tfr-maps-col",
    title: "Colombia fertility by department",
    href: "/maps/col",
    region: "Colombia",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-arg",
    title: "Argentina fertility by province",
    href: "/maps/arg",
    region: "Argentina",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-irn",
    title: "Iran fertility by province",
    href: "/maps/irn",
    region: "Iran",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-mena",
    title: "Middle East & North Africa fertility map",
    href: "/maps/mena",
    region: "Middle East",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  {
    id: "tfr-maps-sau",
    title: "Saudi Arabia fertility by region",
    href: "/maps/sau",
    region: "Middle East",
    topicIds: ["fertility", "maps"],
    keywords: [
  ...
  },
  {
    ...
    keywords: [
      ...
      "consanguinity",
      "cousin marriage",
                  "mixed marriage europe",
                  "netherlands endogamy",
                  "france mariage mixte",
                  "uk interethnic",
      "india intercaste",
      "china interethnic",
      "japan international marriage",
      "brazil interracial",
      "pakistan cousin marriage",
      "bolivia tfr",
      "azerbaijan fertility",
    ],
  },
  {
    id: "germany-buergergeld",
    ...
    keywords: [
      ...
      "sgb ii",
      "germany welfare",
      "citizen benefit nationality",
      "migrationsmonitor",
      "ukraine bürgergeld",
      "syria welfare germany",
    ],
  },
  {
    id: "population-compare",
    ...
    keywords: [
      ...
      "oblast population",
      "paint map",
      "russia china population",
      "far east population",
      "regional population map",
      "download population map",
    ],
  },
  {
    id: "immigrant-fiscal-balance",
    title: "Immigrant fiscal break-even — UK vs Europe",
    href: "/migration/fiscal-balance",
    region: "Europe",
    topicIds: ["migration"],
    keywords: [
      "fiscal impact immigration",
      "net contributor immigrant",
      "polani",
      "uk fiscal migration",
      "pay percentile immigrant",
      "lifetime fiscal balance",
      "burn-murdoch immigration",
    ],
  },
  {
    id: "citizen-flows",
    ...
    keywords: [
      ...
      "return migration",
      "nationals abroad",
      "eurostat citizen flows",
      "romania emigration",
      "luxembourg leave rate",
      "coming home europe",
    ],
  },
  {
    id: "tfr-maps-caribbean",
    title: "Caribbean fertility map",
    href: "/maps/caribbean",
    region: "Caribbean",
    topicIds: ["fertility", "maps"],
    keywords: ["caribbean fertility", "caribbean tfr map"],
  },
  {
    id: "tfr-maps-southamerica",
    title: "South America fertility map",
...
const HUB_INSIGHTS: Record<string, RelatedInsight[]> = {
  "/fertility": [
    ...
    { title: "Fertility by race, origin & income", href: "/fertility/race", region: "Worldwide" },
    { title: "Fertility by education and income", href: "/fertility/education", region: "Worldwide" },
    { title: "Saudi Arabia regional fertility", href: "/maps/sau", region: "Middle East" },
  ...
  "/migration": [
    ...
    { title: "Germany Bürgergeld by nationality", href: "/migration/buergergeld", region: "Germany" },
    { title: "Immigrant fiscal break-even UK vs Europe", href: "/migration/fiscal-balance", region: "Europe" },
    { title: "Citizens leaving and coming home EU EFTA", href: "/migration/citizen-flows", region: "Europe" },
    ...
    { title: "Iran ethnic groups", href: "/demographics/iran", region: "Iran" },
    { title: "Brazil colour / race", href: "/demographics/brazil", region: "Brazil" },
    { title: "Canada visible minority", href: "/demographics/canada", region: "Canada" },
    { title: "South Africa population group", href: "/demographics/south-africa", region: "South Africa" },
  ],
  "/mortality": [
  ...
  "/maps": [
    { title: "India fertility by state", href: "/maps/ind", region: "India" },
    { title: "Pakistan fertility by province", href: "/maps/pak", region: "Pakistan" },
    { title: "Nigeria fertility by state", href: "/maps/nga", region: "Africa" },
    { title: "Brazil fertility by state", href: "/maps/bra", region: "Brazil" },
    { title: "Colombia fertility by department", href: "/maps/col", region: "Colombia" },
    { title: "Argentina fertility by province", href: "/maps/arg", region: "Argentina" },
    { title: "Iran fertility by province", href: "/maps/irn", region: "Iran" },
    { title: "Iraq fertility by governorate", href: "/maps/irq", region: "Middle East" },
    ...
    { title: "Caribbean fertility map", href: "/maps/caribbean", region: "Caribbean" },
  ...
  "/demographics": [
    ...
    { title: "Germany country of birth", href: "/demographics/germany", region: "Germany" },
    { title: "Russia ethnic groups", href: "/demographics/russia", region: "Russia" },
    { title: "Regional fertility maps", href: "/maps", region: "Worldwide" },
  ],
  "/gdp": [
