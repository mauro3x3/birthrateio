...
const BY_ISO3: Record<string, BriefingAngle> = {
  ISR: {
    ...
    stakes: [
      ...
      "Haredi fertility is a religiosity split inside the Jewish population. The Israel Democracy Institute estimates Haredi TFR at 6.4 in 2020–2022 versus 2.5 for other Jewish women, and a Haredi population of about 1.39 million in 2024 (13.9%), with CBS-based projections toward 16% in 2030.",
...
That gap shows up twice in the Treasury. On the tax side, IDI: non-Haredi Jewish households paid about three times more in mandatory contributions (income tax, health, and National Insurance) — NIS 4,496 a month versus NIS 1,469. On the spending side, child allowances scale with the number of children; a TFR of 6.4 versus 2.5 means more Bituach Leumi cheques per household even before any targeted stipend. School places scale the same way: IDI 2023–24, about 401,000 pupils in Haredi education — one in five students in Israel, 26% of the Jewish school system, 28% of elementary. Only 16% of Haredi students were eligible for a bagrut (matriculation) in 2021–22, versus 85% in state and state-religious schools. That is both a current education bill and a later tax-receipt problem if those cohorts earn less.
...
Put a round number on the long run, still as a model not a verdict. The Finance Ministry’s chief economist has estimated that closing Haredi employment and wage gaps would add about 0.6 percentage points to annual growth in the long run. IDI has put the cumulative GDP loss, if today’s education and employment gaps persist, on the order of 10% of GDP by 2050 — about NIS 160 billion in 2023 terms. None of that tells a minister which lever to pull. It does tell a new staffer why the national TFR is the wrong slide for a coalition, education, or defence-budget meeting.`,
    notes: [
      "Cite IDI Haredi TFR as a research estimate, not a CBS vital-statistics religion row.",
